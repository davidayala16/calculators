...
export async function expandEverything(page) {
  ...
  const collapsedByDefaultHeaders = [
    'SOCIAL SECURITY (OPTIONAL)', 'AFTER-TAX WITHDRAWALS', 'ROTH CONVERSION LADDER', 'PART-TIME WORK',
    'ACA SUBSIDY CLIFF', 'REQUIRED MINIMUM DISTRIBUTIONS', 'MEDICARE IRMAA', 'NIIT —', 'LONG-TERM CARE',
    'LEGACY & ESTATE', 'SPENDING GLIDE PATH', 'EARLY RETIREMENT', 'MARKET VOLATILITY', 'WITHDRAWAL ORDER',
